...
===  Exemplos de ações do estagiário em LC nas Escolas

Observando as competências esperadas para um profissional licenciado
em Computação (você em breve), diversas ações podem ser desenvolvidas
ao longo de um estágio no contexto escolar. Algumas delas são
sugeridas a seguir e poderão variar bastante dependendo do nível de
ensino em que você irá trabalhar. Ao desenvolver tais ações, você
estará recebendo a formação técnica, profissional, científica, humana
e social esperada para um licenciado em Computação. Embora sejam
listadas a seguir algumas possíveis ações a desenvolver como
sugestões, muitas outras atividades podem ser desenvolvidas,desde que
o foco seja a formação do profissional de LC que atua no ensino
básico, e que é o objetivo principal do Estágio 2 em LC.

Antes de observar alguns exemplos, tente listar no espaço abaixo
...
.Estagiário atuando como professor de informática
|====
| Atividades
...
.Estagiário atuando como agente promotor do uso da tecnologia na educação
|====
| Atividades
...
seguir, ou pode descobrir que algumas das atividades que pensou não
são na verdade boas atividades para um estágio, mas só tentando
executar essa atividade é que conseguirá ganhar essa maturidade.

Embora existam dois perfis principais para o estágio, suas atividades
...
atividades planejadas para cada uma e recursos de tecnologia ou não
...
importante. Um estágiário de licenciatura em computação poderia
...
==== Atividade: Entendendo seu papel como estagiário exemplificando possíveis ações suas na escola

Como estagiário, você precisa elaborar um plano de atividades.
Considerando o perfil de egresso do curso de Licenciatura em
Computação, suas competências esperadas, os exemplos de ações que o
...
Um outra possível lista de atividades poderia ser esta:
