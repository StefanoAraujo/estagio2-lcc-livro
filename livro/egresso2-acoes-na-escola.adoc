...
Caso a escola não tenha computadores, podem também ser exploradas atividades
de computação desplugada, como as que são propostas nos seguintes sites:

* http://csunplugged.org/
* https://sites.google.com/a/dce.ufpb.br/computacao-desplugada/

A ideia do ensino do pensamento computacional é tentar mostrar que para
resolver problemas devemos estruturar os passos para se chegar à sua solução.
